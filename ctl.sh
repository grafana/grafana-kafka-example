...
case "$1" in
  ...
  configure)
    ...
    _modifyYml $GRAFANA_PROMTAIL_CONFIG_FILE "__GRAFANA_LOGS_URL__"         "$GRAFANA_LOGS_URL"
    _modifyYml $GRAFANA_PROMTAIL_CONFIG_FILE "__GRAFANA_LOGS_USERNAME__"    "$GRAFANA_LOGS_USERNAME"
    _modifyYml $GRAFANA_PROMTAIL_CONFIG_FILE "__GRAFANA_LOGS_API_KEY__"     "$GRAFANA_LOGS_API_KEY"
